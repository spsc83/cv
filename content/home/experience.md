...
experience:
  - title: Senior Data Engineer
    ...
    description: |2-
        ...
        * QC Service Project: The QC service is a web application functioning as the primary decision engine, utilizing defined metrics per Standard Operating Procedure and delivering decision outcomes. In this project, I designed the data module for the QC decision engine and developed the Restful API service using the FastAPI framework. This QC service serves as a critical step in the data processing pipeline of GeneDx.
        * WGS in Cloud project: This project involves the development of GeneDx's new WGS pipeline within the AWS environment. I was fortunate to be involved in this project, where my responsibilities encompass managing data transfer operations between AWS S3 and on-premises storage systems. Leveraging Python scripting, I successfully implemented the IAM roles anywhere method, establishing a secure mechanism for the application to acquire temporary AWS credentials. Additionally, I effectively developed data transfers between AWS S3 and on-premises storage systems with AWS Boto3. It is the essential part of the WGS in Cloud project.
